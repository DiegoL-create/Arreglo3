...
public class Ventas {
    ...
    public static void main(String[] args) throws Validaciones {
        ...
        TicketDetalles objTic1 = new TicketDetalles((byte) 3, 0.0, 0.0, 0.0, 0.0, 0.016, opc);
        Ticket.generarFolio();
        Ticket.generarFecha();
        do {
            try {
        ...
        do {
            try {
                objCliente1
                        .setIdCliente(Short.parseShort(JOptionPane.showInputDialog("introduce el id del cliente:  ")));
        ...
        do {
            do {
                try {
                    objProducto1.setIdProducto(
                            Integer.parseInt(JOptionPane.showInputDialog("introduce el id del producto: ")));
            ...
            do {
                try {
                    objProducto1.setPrecio(
                            Double.parseDouble(JOptionPane.showInputDialog("introduce el costo del producto: ")));
            ...
            do {
                try {
                    objTic1.setCantidadPro(
                            Byte.parseByte(JOptionPane.showInputDialog("introduce la cantidad del producto: ")));
            ...
            Respuesta = Integer
                    .parseInt(JOptionPane.showInputDialog("¿hay algun otro articulo que desea comprar (si 1 /no 2): "));
        } while (Respuesta == 1);
        ...
        switch (opc) {
            case 1:
                objTic1.generarSubtotal(objTic1.getSubTotal());
                break;
            case 2:
                objTic1.generarTotal1(objTic1.getFactura());
        }
